                  ...
                  _c(
                    ...
                    [
                      comment.user.dp != "default.gif"
                        ? _c("v-img", {
                            attrs: { src: "./storage/pics/" + comment.user.dp }
                          })
          ...
          _c(
            ...
            [
              _vm.user.dp != "default.gif"
                ? _c("v-img", {
                    attrs: { src: "./storage/pics/" + _vm.user.dp }
                  })
                : _c("v-icon", { attrs: { dark: "" } }, [
                    _vm._v("mdi-account-circle")
                  ])
                ...
                [
                  _c(
                    ...
                    [
                      user.dp != "default.gif"
                        ? _c("v-img", {
                            attrs: { src: "./storage/pics/" + user.dp }
                          })
                        : _c("v-icon", { attrs: { dark: "" } }, [
                            _vm._v("mdi-account-circle")
                          ])
                  ...
                  _c(
                    ...
                    [
                      post.user.dp != "default.gif"
                        ? _c("v-img", {
                            attrs: { src: "./storage/pics/" + post.user.dp }
                          })
                        : _c("v-icon", { attrs: { dark: "" } }, [
                            _vm._v("mdi-account-circle")
                          ])
