		...
		<v-row class="mb-12">
			<v-col cols="12">
				<v-card class="mt-0" height="300px" tile>
						...
						<v-row align="end" class="fill-height">
							<v-col align-self="start" class="pa-0" cols="12">
								<v-avatar class="profile mx-8 my-8" color="grey" size="164" rounded @click.stop="onAvatarClick">
									...
									<v-img v-else :src="`http://localhost/redrosse/api/public/storage/pics/${user.dp}`"></v-img>
								</v-avatar>
					...
					<v-img v-else height="100%" :src="`http://localhost/redrosse/api/public/storage/pics/${user.cover}`" @click.self="onCoverPhotoClick">
						<v-row align="end" class="fill-height">
							<v-col align-self="start" class="pa-0" cols="12">
								<v-avatar class="profile mx-8 my-8" color="grey" size="164" rounded @click.stop="onAvatarClick">
									<v-img v-if="user.dp == 'default.gif'" :src='require(`../assets/img/dps/${user.dp}`)'></v-img>
